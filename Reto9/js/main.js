...
const kodersCollection = [
    {
        ...
        bootcamp: 'JavaScript',
        scores: [
            { module: 'Frontend', score: 90},
            { module: 'Backend', score: 80},
            { module: 'Cloud', score: 80}
        ]
    },
    {
        name: 'Ale', 
        ...
        scores: [
            { module: 'Frontend', score: 90},
            { module: 'Backend', score: 100},
            { module: 'Cloud', score: 100}
        ]
    },
    {
        name: 'Juan Pablo', 
        ...
        bootcamp: 'JavaScript',
        scores: [
            { module: 'Frontend', score: 100},
            { module: 'Backend', score: 95},
            { module: 'Cloud', score: 80}
        ]
    },
    {
        ...
        bootcamp: 'Python',
        scores: [
            { module: 'Frontend', score: 98},
            { module: 'Backend', score: 100},
            { module: 'Cloud', score: 70}
        ]
    },
    {
        name: 'Javier', 
        ...
        bootcamp: 'JavaScript',
        scores: [
            { module: 'Frontend', score: 80},
            { module: 'Backend', score: 90},
            { module: 'Cloud', score: 100}
        ]
    }
]
